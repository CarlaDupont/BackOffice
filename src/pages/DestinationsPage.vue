...
export default {
  ...
  methods: {
    ...
    updatePreview() {
      ...
      console.log(this.form.previewUrl)
    },
    ...
    async saveDestination() {
      ...
      if (this.form.file) {
        ...
        if (uploadError) console.error("Échec de l'upload de l'image", uploadError)
        await supabase.from('destinations').update({ image_path: path }).eq('id', recordId)
      }
